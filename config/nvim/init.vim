" Add ~/.vim to runtimepath for plug.vim and colorscheme
...
set splitright       " Split new vertical window to the right of current one
...
set shortmess+=s     " Don't give search hit BOTTOM, continuing at TOP messages
